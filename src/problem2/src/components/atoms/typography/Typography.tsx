...
export const typographyVariants = cva("font-sans", {
  variants: {
    variant: {
      ...
      h3: "text-4xl font-[500] leading-normal",
      h4: "text-3xl font-[500] leading-normal",
      subhead: "text-2xl font-[500] leading-normal tracking-[-0.4px]",
      subhead2: "text-lg font-[500] leading-normal",
